...
const SubscriptionsPage: React.FC = () => {
  ...
  return (
    <div className="subscriptions-page">
      <header className="subscriptions-topbar"><a href="#/dashboard/overview" className="subscriptions-brand"><span>V</span>Drishti</a><nav><a href="#/dashboard/overview">Operations</a><a className="active" href="#/subscriptions">Subscriptions</a><a href="#/receivables">Receivables</a><a href="#/dashboard/analytics">Analytics</a></nav><a href="#/page/client-login" className="subscriptions-login">Client login</a></header>
